...
void main() {
  ...
  test('complete() on a daily reminder recomputes next_due_date and stays active', () async {
  ...
  test('complete() writes a reminder_logs row', () async {
    ...
    final logs = await (db.select(db.reminderLogs)
          ..where((l) => l.reminderId.equals(id)))
        .get();
